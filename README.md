...
The deployed version of the site is hosted with GitHub Pages and can be accessed directly in any modern web browser:
...
or serve the directory using a static server of your choice.
...
Integration of backend services or deployment pipelines.
